    ...
    public partial class Initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserUceCases", x => new { x.UserId, x.UseCaseId });
                    table.ForeignKey(
                        name: "FK_UserUceCases_UseCases_UseCaseId",
                        column: x => x.UseCaseId,
                        principalTable: "UseCases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserUceCases_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentEquipments", x => new { x.ApartmentId, x.EquipmentId });
                    table.ForeignKey(
                        name: "FK_ApartmentEquipments_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApartmentEquipments_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentImages", x => new { x.ApartmentId, x.ImageId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartmentRooms", x => new { x.ApartmentId, x.RoomTypeId });
                    table.ForeignKey(
                        name: "FK_ApartmentRooms_Apartments_ApartmentId",
                        column: x => x.ApartmentId,
                        principalTable: "Apartments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ApartmentRooms_RoomTypes_RoomTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentEquipments_EquipmentId",
                table: "ApartmentEquipments",
                column: "EquipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApartmentRooms_RoomTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserUceCases_UseCaseId",
                table: "UserUceCases",
                column: "UseCaseId");
        }
